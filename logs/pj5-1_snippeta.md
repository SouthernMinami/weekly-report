...
![Untitled](%E3%82%A2%E3%83%97%E3%83%AA%E9%96%8B%E7%99%BA%E3%83%AD%E3%82%B0%EF%BC%9ASnippeta%20b39e79c6f2d246a9934f1b44d5356599/Untitled.png)
...
server {
	...
	listen 443 ssl; #managed by certbot
	ssl_certificate /etc/letsencrypt/live/snippeta.kano.wiki/fullchain.pem;
	ssl_certificate_key /etc/letsencrypt/live/snippeta.kano.wiki/privkey.pem;
	include /etc/letsencrypt/options-ssl-nginx.conf;
	ssl_dhparam /etc/letsencrypt/ssl-dhparams.pem;
}
server {
	if ($host = snippeta.kano.wiki) {
...
- [ ]  ルートパスと/new以外にアクセス出来ない
- [ ]  投稿ボタンと言語ドロップダウンのみJavascriptが効いてない

そもそもEC2でmysqlインストールしてない
